...
public class MainActivity extends Fragment{// implements View.OnClickListener{
	...
	private static Button delMulti, setAll, setComplete;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		setAll = (Button)rootView.findViewById(R.id.chooseAll);
...
//		}
		bottomBar = (LinearLayout) rootView.findViewById(R.id.fullscreen_content_controls);
